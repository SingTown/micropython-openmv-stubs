...
MicroPython module: https://docs.micropython.org/en/preview/library/rtsp.html
...
# origin module:: repos/micropython/docs/library/rtsp.rst
...
class rtsp_server:
    ...
    def __init__(self, network_if, port=554) -> None: ...
    def register_setup_cb(self, cb) -> Incomplete:
        """
    ...
    def register_play_cb(self, cb) -> Incomplete:
        """
    ...
    def register_pause_cb(self, cb) -> Incomplete:
        """
    ...
    def register_teardown_cb(self, cb) -> Incomplete:
        """
    ...
    def stream(self, cb, quality=90) -> Image:
        """
