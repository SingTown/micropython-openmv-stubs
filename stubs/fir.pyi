...
MicroPython module: https://docs.micropython.org/en/preview/library/fir.html
...
# origin module:: repos/micropython/docs/library/fir.rst
...
FIR_NONE: Incomplete
"""No FIR sensor type."""
FIR_SHIELD: Incomplete
"""The OpenMV Cam Thermopile Shield Type (MLX90621)."""
FIR_MLX90621: Incomplete
"""FIR_MLX90621 FIR sensor."""
FIR_MLX90640: Incomplete
"""FIR_MLX90640 FIR sensor."""
FIR_MLX90641: Incomplete
"""FIR_MLX90640 FIR sensor."""
FIR_AMG8833: Incomplete
"""FIR_AMG8833 FIR sensor."""
FIR_LEPTON: Incomplete
"""FIR_LEPTON FIR sensor."""
def init(type=-1, refresh, resolution: Optional[Any]=None) -> Incomplete:
    """
...
def radiometric() -> Incomplete:
    ...
    """
    ...
def register_vsync_cb(cb) -> Incomplete:
    """
    ...
    """
    ...
def register_frame_cb(cb) -> Incomplete:
    """
       For the `fir.FIR_LEPTON` mode only on the OpenMV Cam Pure Thermal.
...
def get_frame_available() -> bool:
    ...
    """
    ...
def trigger_ffc(timeout=-1: Optional[Any]=None) -> Incomplete:
    """
...
def read_ta() -> Incomplete:
    ...
    """
    ...
def read_ir(hmirror=False, vflip=False, transpose=False, timeout=-1) -> Tuple:
    """
    ...
    """
    ...
def draw_ir(image, ir, x, y, x_scale=1.0, y_scale=1.0, roi=None, rgb_channel=-1, alpha=128, color_palette=image.PALETTE_RAINBOW, alpha_palette=-1, hint=0, scale=(ir_min, ir_max): Optional[Any]=None) -> Incomplete:
    """
    ...
    """
    ...
def snapshot(hmirror=False, vflip=False, transpose=False, x_scale=1.0, y_scale=1.0, roi=None, rgb_channel=-1, alpha=128, color_palette=PALETTE_RAINBOW, alpha_palette=None, hint=0, scale=(ir_min, ir_max), pixformat=image.RGB565, copy_to_fb=False, timeout=-1) -> image:
    """
