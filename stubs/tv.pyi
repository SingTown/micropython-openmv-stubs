...
MicroPython module: https://docs.micropython.org/en/preview/library/tv.html
...
# origin module:: repos/micropython/docs/library/tv.rst
...
TV_SHIELD: Incomplete
"""Used to initialize the TV module."""

def init(type=TV_SHIELD, triple_buffer=False) -> Incomplete:
    """
...
def channel(channel: Optional[Any] = None) -> Incomplete:
    """
...
def display(
    image, x=0, y=0, x_scale=1.0, y_scale=1.0, roi=None, rgb_channel=-1, alpha=256, color_palette=None, alpha_palette=None, hint=0
) -> Incomplete:
    """
