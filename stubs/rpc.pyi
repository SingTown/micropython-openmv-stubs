...
MicroPython module: https://docs.micropython.org/en/preview/library/rpc.html
...
# origin module:: repos/micropython/docs/library/rpc.rst
...
class rpc:
    ...
    def get_bytes(self, buff, timeout_ms) -> None:
        """
    ...
    def put_bytes(self, data, timeout_ms) -> Incomplete:
        """
        This method is meant to be reimplemented by specific interface classes of `rpc_master` and `rpc_slave`.
    ...
    def stream_reader(self, call_back, queue_depth=1, read_timeout_ms=5000) -> Incomplete:
        """
    ...
    def stream_writer(self, call_back, write_timeout_ms=5000) -> bytesormemoryview:
        """
        This method is meant to be called directly. After synchronization of the master and slave on return
...
class rpc_master:
    ...
    def __init__(self) -> None: ...
    def call(self, name, data=bytes(), send_timeout=1000, recv_timeout=1000) -> Incomplete:
        """
...
class rpc_slave:
    ...
    def __init__(self) -> None: ...
    def register_callback(self, cb) -> like:
        """
    ...
    def schedule_callback(self, cb) -> Incomplete:
        """
    ...
    def setup_loop_callback(self, cb) -> Incomplete:
        """
    ...
    def loop(self, recv_timeout=1000, send_timeout=1000) -> Incomplete:
        """
...
class rpc_can_master:
    ...
    * can_bus - CAN Bus number to use
    ...
    def __init__(self, message_if=0x7FF, bit_rate=250000, sample_point=75, can_bus=2) -> None: ...
...
class rpc_can_slave:
    ...
    * can_bus - CAN Bus number to use
    ...
    def __init__(self, message_id=0x7FF, bit_rate=250000, sample_point=75, can_bus=2) -> None: ...
...
class rpc_i2c_master:
    ...
    * i2c_bus - I2C bus number to use.
    ...
    def __init__(self, slave_addr=0x12, rate=100000, i2c_bus=2) -> None: ...
...
class rpc_i2c_slave:
    ...
    * i2c_bus - I2C bus number to use.
    ...
    def __init__(self, slave_addr=0x12, i2c_bus=2) -> None: ...
...
class rpc_spi_master:
    ...
    * spi_bus - SPI bus number to use.
    ...
    def __init__(self, cs_pin="P3", freq=10000000, clk_polarity=1, clk_phase=0, spi_bus=2) -> None: ...
...
class rpc_spi_slave:
    ...
    * spi_bus - SPI bus number to use.
    ...
    def __init__(self, cs_pin="P3", clk_polarity=1, clk_phase=0, spi_bus=2) -> None: ...
...
class rpc_uart_master:
    ...
    * uart_port - UART port to use.
    ...
    def __init__(self, baudrate=115200, uart_port=3) -> None: ...
...
class rpc_network_master:
    ...
    * port - Port to route traffic to.
    ...
    def __init__(self, network_if, port=0x1DBA) -> None: ...

class rpc_network_slave:
    """
