...
MicroPython module: https://docs.micropython.org/en/preview/library/pyb.html
...
# + module: pyb.CAN.rst
# + module: pyb.DAC.rst
# + module: pyb.ExtInt.rst
# + module: pyb.Flash.rst
# + module: pyb.I2C.rst
# + module: pyb.LED.rst
# + module: pyb.Pin.rst
# + module: pyb.RTC.rst
# + module: pyb.Servo.rst
# + module: pyb.SPI.rst
# + module: pyb.Timer.rst
# + module: pyb.UART.rst
...
class UART:
    ...
    def init(self, baudrate, bits=8, parity=None, stop=1, *, timeout=1000, flow=0, timeout_char=0, read_buf_len=64) -> None:
        """
